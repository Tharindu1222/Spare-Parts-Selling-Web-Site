<?php
    session_start();
    $db_name = "engine";
    $connection = mysqli_connect("localhost","root","","engine");
    ...
    if(isset($_POST["add"])){
        if(isset($_SESSION["shopping_cart"])){
            ...
            if(!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="engine.php"</script>';
            }else{
        ...
        if($_GET["action"] == "delete"){
            foreach($_SESSION["shopping_cart"] as $keys => $value){
                if($value["product_id"] == $_GET["id"]){
                    ...
                    echo '<script>window.location="exhaust.php"</script>';
                }
            }
        }
    }
...
<body>
    ...
    <div class="container" style="width: 65%">
        <h1><center><a href="#" class="logo">engine <span> Modification </span> cart</a></center></h1> <br><br>
        <?php
            ...
            if(mysqli_num_rows($result)>0){
                while($row = mysqli_fetch_array($result)){
                    ...
                    <div class="col-md-3" style="float: left;">
                        <form method="post" action="engine.php?action=add&id=<?php echo $row["id"];?>">
                            <div class="product">
        ...
        <h1><center><a href="#" class="logo">engine <span> Modification </span> cart <span> details </span></a> </center></h1> <br>
        <div class="table-responsive">
            ...
            <?php
                ...
                <tr>
                        ...
                        <td><a href="engine.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span class="text-danger">Remove Item</span></a></td>
                </tr>
                <?php
