<?php
    session_start();
    $db_name = "offer";
    $connection = mysqli_connect("localhost","root","","offer");
...
<body>
    ...
    <div class="container" style="width: 65%">
        <h1><center><a href="#" class="logo">offer <span> Modification </span> cart</a></center></h1> <br><br>
        <?php
            ...
            if(mysqli_num_rows($result)>0){
                while($row = mysqli_fetch_array($result)){
                    ...
                    <div class="col-md-3" style="float: left;">
                        <form method="post" action="offer.php?action=add&id=<?php echo $row["id"];?>">
                            <div class="product">
        ...
        <h1><center><a href="#" class="logo">offer <span> Modification </span> cart <span> details </span></a> </center></h1> <br>
        <div class="table-responsive">
            ...
            <?php
                ...
                <tr>
                        ...
                        <td><a href="offer.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span class="text-danger">Remove Item</span></a></td>
                </tr>
                <?php
